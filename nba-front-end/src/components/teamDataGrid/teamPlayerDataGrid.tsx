...
const teamPlayerColumns: GridColDef[] = [
    { field: 'TeamID', headerName: 'Team ID', width: 90, hide: false },
    { field: 'TeaName', headerName: 'Team Name', width: 90, hide: false },
    { field: 'PlayerID', headerName: 'Player ID', width: 90, hide: false },
